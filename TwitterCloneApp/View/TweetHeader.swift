...
//  TwitterCloneApp
//
//  Created by CEVAT UYGUR on 28.12.2022.
//
...
class TweetHeader: UICollectionReusableView {
    ...
    private let captionLabel: UILabel = {
       let label = UILabel()
        ...
        label.text = "Some test caption from cevatuygur Some test caption from cevatuygur Some test caption from cevatuygur Some test caption from cevatuygur"
        return label
    }()
